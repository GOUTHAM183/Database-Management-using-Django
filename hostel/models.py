...
class Room(models.Model):
    hostel = models.ForeignKey(
        Hostel, related_name="hostel_room", on_delete=models.CASCADE
    )
...
class Student(models.Model):
    hostel = models.ForeignKey(
        Hostel, related_name="hostel_students", on_delete=models.CASCADE
    )
    gender_choices = [("N", "None"), ("M", "Male"), ("F", "Female")]
    room = models.ForeignKey(
        Room, related_name="room_students", on_delete=models.CASCADE
    )
    ...
    gender = models.CharField(
        choices=gender_choices, max_length=1, default="N", null=True
    )
...
class Fees(models.Model):
    student = models.ForeignKey(
        Student, related_name="student_fees", on_delete=models.CASCADE
    )
...
class Staff(models.Model):
    hostel = models.ForeignKey(
        Hostel, related_name="hostel_staff", on_delete=models.CASCADE
    )
...
class Parents(models.Model):
    student = models.ForeignKey(
        Student, related_name="student_parents", on_delete=models.CASCADE
    )
...
class Visitors(models.Model):
    student = models.ForeignKey(
        Student, related_name="student_visitors", on_delete=models.CASCADE
    )
